...
<div class="container-sm form-custom">
	<form action="/registro.php" class="mb-ch-28" data-submit="Formulario de inscripcion" method="post" id="formRegistro" name="formRegistro">
		...
		<div class="text-left">
			  <label>
						By clicking SEND, the user accepts <a href="http://app.utec.edu.pe/documentacion/terminos-y-condiciones.pdf" target="_blank">the terms and conditions detailed here.</a>
			  </label>	
	    </div>				
	</form>						
</div>
