            ...
            <?php if ($child['#href']) : ?>
              ...
              ?>
                  ...
                  <?php $external = substr($child['#href'], 0, 4); ?>
  								<a href="<?php if ($external != 'http'){print '/'} if($language->language == 'en'){print ($language->language."/");} print $href; ?>" 
                     ...
                     style="<?php if ($classes){print 'color:white';} ?>"><?php print $titles[0]; ?></span><?php print $titles[1]; ?> <?php print $titles[2]; ?> <?php print $titles[3]; ?> <?php print $titles[4]; ?></a>
  						...
  						<ul>
                <li>
                  <a href="<?php if ($external != 'http'){print '/'} if($language->language == 'en'){print ($language->language."/");} print $href; ?>" class="<?php foreach ($classes as $key => $class){print $class.' ';
