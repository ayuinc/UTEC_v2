          ...
          <?php if ($menu['#href']) : ?>
            ...
            <?php if ($child['#href']) : ?>
              ...
              ?>
                  ...
                  } ?>atm-menu-secundario" title="<?php print $title; ?>" id="<?php print $id; ?>" name="<?php print $name; ?>" rel="<?php print $rel; ?>" target="<?php print $target; ?>"><span class="<?php if ($classes){print 'text-white';} ?>" style="<?php if ($classes){print 'background-color:white';} ?>"><?php print $titles[0]; ?></span><?php print $titles[1]; ?> <?php print $titles[2]; ?> <?php print $titles[3]; ?> <?php print $titles[4]; ?></a>
  							</li>
