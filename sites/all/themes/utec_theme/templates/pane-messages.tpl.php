...
<?php if (!empty($messages)): ?>
  <?php //print $messages; ?>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  <div class="modal-dialo modal-lg" role="document">
	      ...
	      <div class="modal-body text-center php-21">
	      	...
	      	<h4 class="text-center mv-21 medium">Share your experience</h4>
				  <?php 
				  	...
				  	print_r($node);
				  	$path = $directory.'/sites/all/themes/utec_theme/assets/img/';
				  ?>
	        ...
	        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php print $url.'/'.$language->language.'/'.$path_i18; ?>"><img src="<?php print $path.'facebook.png' ?>"></a>
	      	<a href="https://twitter.com/home?status=<?php print $og_description ?>"><img src="<?php print $path.'twitter.png' ?>"></a>
	      	<a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php print $url.'/'.$language->language.'/'.$path_i18; ?>&title=<?php print $og_title ?>&summary=&source="><img src="<?php print $path.'linkedin.png' ?>"></a>
	      	<a href="https://plus.google.com/share?url=<?php print $url ?>"><img src="<?php print $path.'gplus.png' ?>"></a>
	      </div>
