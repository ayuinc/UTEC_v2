...
<div class="container-sm">
	...
	<ul class="grid-list grid-list-3 grid-list-1-xs grid-list-hover size sm">
		...
		<?php endif ?>
			<div>
				<h2 class="thin lead lh-lg"><?php print t('Top Academic Rankings') ?></h2>
				<div class="size lg">
		...
		<?php endif ?>		
			<div>
				<h2 class="thin lead lh-lg"><?php print t('High Performance Assessment') ?></h2>
				<div class="size lg">
		...
		<?php endif ?>				
			<div>
				<h2 class="thin lead lh-lg"><?php print t('Transfer Students') ?></h2>
				<div class="size lg">
		...
		<?php endif ?>			
			<div>
				<h2 class="thin lead lh-lg"><?php print t('Pre University Center') ?></h2>
				<div class="size lg">
		...
		<?php endif ?>		
			<div>
				<h2 class="thin lead lh-lg"><?php print t('International Baccalaureate') ?></h2>
				<div class="size lg">
		...
		<?php endif ?>			
			<div>
				<h2 class="thin lead lh-lg"><?php print t('Admissions Exam') ?></h2>
				<div class="size lg">
