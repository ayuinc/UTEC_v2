...
<div class="container-sm">
	...
	<ul class="grid-list grid-list-3 grid-list-1-xs grid-list-hover size sm">
		...
		<?php endif ?>
			<div>
				<h3 class="h4 thin lead lh-lg"><?php print t('Top Academic Rankings') ?></h3>
				<div class="size lg">
		...
		<?php endif ?>		
			<div>
				<h3 class="h4 thin lead lh-lg"><?php print t('High Performance Assessment') ?></h3>
				<div class="size lg">
		...
		<?php endif ?>				
			<div>
				<h3 class="h4 thin lead lh-lg"><?php print t('Transfer') ?></h3>
				<div class="size lg">
		...
		<?php endif ?>			
			<div>
				<h3 class="h4 thin lead lh-lg"><?php print t('Pre University Center') ?></h3>
				<div class="size lg">
		...
		<?php endif ?>		
			<div>
				<h3 class="h4 thin lead lh-lg"><?php print t('International Baccalaureate') ?></h3>
				<div class="size lg">
		...
		<?php endif ?>			
			<div>
				<h3 class="h4 thin lead lh-lg"><?php print t('Admission Exam') ?></h3>
				<div class="size lg">
