		...
		<table class="table mt-35">
			...
			<tbody>
				<tr>
					...
					<td class="text-gray"><a href="/sites/default/files/temporales-investigacio/JR2_6_Switching Selectivity in Oxidation Reactions on Gold_The Mechanism.pdf" target="_blank">Switching Selectivity in Oxidation Reactions on Gold: The Mechanism of C–C vs C–H Bond Activation in the Acetate Intermediate on Au</a></td>
				...
				<tr>
					...
					<td class="text-gray"><a href="/sites/default/files/temporales-investigacio/JR4_13_van der Waals interactions determine selectivity in catalysis by metallic gold.pdf" target="_blank">Van der Waals interactions determine selectivity in catalysis by metallic gold</a></td>
					<td class="text-gray">2014</td>
					<td class="text-gray">Publicado</td>					
				</tr>
				<tr>
					...
					<td class="text-gray"><a href="/sites/default/files/temporales-investigacio/AR8_1_Industrial Internet Education_Issues and.pdf" target="_blank">Industrial Internet Education: Issues and Opportunities</a></td>
					<td class="text-gray">2014</td>
					<td class="text-gray">Publicado</td>					
				</tr>
				<tr>
					...
					<td class="text-gray"><a href="/sites/default/files/temporales-investigacio/EV1_2_ Contactless automated manipulation of mesoscale objects using opto-fluidic actuation and visual servoing.pdf" target="_blank">Contactless automated manipulation of mesoscale objects using opto-fluidic actuation and visual servoing</a></td>
					<td class="text-gray">2014</td>
					<td class="text-gray">Publicado</td>					
				</tr>	
				<tr>
					...
					<td class="text-gray"><a href="/sites/default/files/temporales-investigacio/JC1_3_ANÁLISIS DE BIODIESEL PREPARADO A PARTIR DE RESIDUOS.pdf" target="_blank">Análisis de biodiesel preparado a partir de residuos de aceite doméstico</a></td>
					<td class="text-gray">2014</td>
					<td class="text-gray">Publicado</td>					
				</tr>
				<tr>
					...
					<td class="text-gray"><a href="/sites/default/files/temporales-investigacio/JN2_5_Design of an 10 kVA-45 A automatic static transfer switch module.pdf" target="_blank">Design of an 10 kVA-45 A automatic static transfer switch module</a></td>
					<td class="text-gray">2014</td>
					<td class="text-gray">Publicado</td>					
				</tr>
				<tr>
					...
					<td class="text-gray"><a href="/sites/default/files/temporales-investigacio/OM2_9_Which Are The Main Drivers Behind Residential Electricity Prices.pdf" target="_blank">Análisis de los determinantes (drivers) del precio de la electricidad en Europa</a></td>
					<td class="text-gray">2014</td>
					<td class="text-gray">Publicado</td>					
				</tr>	
				<tr>
				...
				<tr>
					...
					<td class="text-gray"><a href="/sites/default/files/temporales-investigacio/VM2_11_A Multiscale Optimization Approach to Detect Exudates in the Macula.pdf" target="_blank">A Multiscale Optimization Approach to Detect Exudates in the Macula</a></td>
					<td class="text-gray">2014</td>
					<td class="text-gray">Publicado</td>					
				</tr>	
				<tr>
					...
					<td class="text-gray"><a href="/sites/default/files/temporales-investigacio/VM1_10_Scalable Open-Source Architecture for Real-Time Monitoring of Adaptive Wiring Panels.pdf" target="_blank">Scalable Open-Source Architecture for Real-Time Monitoring of Adaptive Wiring Panels</a></td>
					<td class="text-gray">2014</td>
					<td class="text-gray">Publicado</td>					
				</tr>		
				<tr>
