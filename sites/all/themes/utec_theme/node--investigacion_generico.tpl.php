...
<div class="container-sm mb-35">
	...
	<?php if ($field_foto_inv_generico!='') { ?>
		<img src="<?php print image_style_url($image_style, $field_foto_inv_generico); ?>" class="img-responsive mb-35" alt="<?php print $title ?>">
	<?php } ?>
	...
	<?php if ($end == 'proyectos') { ?>
		<table class="table mt-35">
			<thead>
				<tr>
					<td class="medium"><?php print t('Researcher') ?></td>
					<td class="medium"><?php print t('Type') ?></td>
					<td class="medium"><?php print t('Department') ?></td>
					<td class="medium"><?php print t('Published on') ?></td>
					<td class="medium"><?php print t('Title') ?></td>
					<td class="medium"><?php print t('Year') ?></td>
					<td class="medium"><?php print t('Status') ?></td>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td class="highlight">Juan Carlos Rodriguez</td>
					<td class="text-gray"><?php print t('Article') ?></td>
					<td class="text-gray"><?php print t('Industrial Chemistry') ?></td>
					...
					<td class="text-gray"><?php print t('Published') ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="text-gray"><?php print t('Electronics') ?></td>
				...
				<tr>
					...
					<td class="text-gray"><?php print t('Article') ?></td>
					<td class="text-gray">?php print t('Mechanics') ?></td>
