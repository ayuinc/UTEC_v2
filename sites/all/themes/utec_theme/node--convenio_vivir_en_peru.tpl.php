...
<div class="scroll-down-white section-scroll-content bg-img-block
bg-img-block-lg" style="background-size: cover; background-position:
center; background-image: url(<?php print
image_style_url($image_style_2, $imagen_cabecera); ?>);">
...
rel="nofollow"><i class="icon-arrows-down bg-cyan"></i></a>
</div>
</div> <!-- END:Hero -->
<!-- BLOQUE 2 -->
...
<div id="carousel-custom" class="carousel carousel-custom slide mb-42
mt-28" data-ride="carousel">
<!-- Wrapper for slides -->
...
image_style_url($image_style, $imagen_bloque_2['uri']); ?>);">
</div>
</div>
</div>
<?php endif ?>
...
<a href="bloque-tres-<?php print $count; ?>"><span><?php print
$titulo_tab_bloque_3['value'] ?></span>
</a>
</li>
<?php $count++; ?>
<?php endforeach ?>
...
<section id="bloque-tres-<?php print $count; ?>" class="<?php ($count
== 0) ? print 'content-current' : '' ; ?>">
...
<div class="hidden-lg">
<?php $count = 0; ?>
<div class="panel-group" id="accordion0" role="tablist"
...
style="cursor:pointer;" class="display-block">
...
<div id="collapse<?php print $count; ?>" class="panel-collapse
collapse" role="tabpanel" aria-labelledby="heading<?php print $count;
?>">
...
<li class="<?php ($count == 0) ? print 'tab-current' : '' ; ?>">
<a href="bloque-cuatro-<?php print $count; ?>"><span><?php print
$titulo_tab_bloque_4['value'] ?></span>
</a>
</li>
<?php $count++; ?>
<?php endforeach ?>
...
<section id="bloque-cuatro-<?php print $count; ?>" class="<?php
($count == 0) ? print 'content-current' : '' ; ?>">
...
<div id="collapse1<?php print $count; ?>" class="panel-collapse
collapse" role="tabpanel" aria-labelledby="heading1<?php print $count;
?>">
<div class="panel-body">
...
<!-- <i class="<?php //print $imagen_bloque_5['value']; ?>"
style="font-size:5rem"></i> -->
<img src="<?php print image_style_url($image_styles_5,
$imagen_bloque_5['uri']); ?>" alt="">
</div>
</li>
...
<div><?php print 'S/. '.$currency.'
'.$contenidos_bloque_5[$key]['value']; ?></div>
<?php else: ?>
...
<li class="<?php ($count == 0) ? print 'tab-current' : '' ; ?>">
<a href="bloque-seis-<?php print $count; ?>"><span><?php print
$titulo_tab_bloque_6['value'] ?></span>
</a>
</li>
<?php $count++; ?>
<?php endforeach ?>
...
<section id="bloque-seis-<?php print $count; ?>" class="<?php ($count
== 0) ? print 'content-current' : '' ; ?>">
...
<div id="collapse2<?php print $count; ?>" class="panel-collapse
collapse" role="tabpanel" aria-labelledby="heading2<?php print $count;
?>">
<div class="panel-body">
...
<div class="banner banner-label-bottom mb-7 ml-0">
<div class="banner-pic" style="background-image: url(<?php print
image_style_url($image_style, $imagen_bloque_6['uri']); ?>);">
</div>
</div>
</div>
<?php endif ?>
