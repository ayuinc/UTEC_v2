...
<div class="hero-unit"> <!-- HERO -->
  <div class="scroll-down-white section-scroll-content bg-img-block bg-img-block-lg" style="background-size: cover; background-position: center; background-image: url(<?php print
        ...
        <div class="hidden-xs hidden-sm">
          <div class="tabs tabs-style-linebox">
            <nav>
              <ul>
                <?php $count = 0; ?>
                <?php foreach ($titulos_tab_bloque_4 as $key =>
$titulo_tab_bloque_4): ?>
                <li class="<?php ($count == 0) ? print 'tab-current' : '' ; ?>">
...
?>"><span><?php print $titulo_tab_bloque_4['value'] ?></span>
            ...
            <div class="content-wrap bg-gray-lighter" style="color: black;">
              <?php $count = 0; ?>
              <?php foreach ($cuerpos_tab_bloque_4 as $key =>
$cuerpo_tab_bloque_4): ?>
              <section id="bloque-cuatro-<?php print $count; ?>"
class="<?php ($count == 0) ? print 'content-current' : '' ; ?>">
                <p style="color: black;"><?php print
$cuerpo_tab_bloque_4['value'] ?></p>
              </section>
              <?php $count++;?>
              <?php endforeach ?>
            </div><!-- /content -->
...
<div class="container-sm section-scroll-content pt-35" id="block6">
  <div class="mh-21">
    ...
    <div class="separator-gray separator-sm"></div>
    <div class="p-ch-gray-dark">
      <div id="carousel-bloque6" class="carousel carousel-custom slide
mb-42 mt-42" data-ride="carousel">
        <!-- Indicators -->
        <ol class="carousel-indicators">
          <?php $count = 0; ?>
          <?php foreach ($imagenes_bloque_4 as $key => $imagen_bloque_4): ?>
          <li data-target="#carousel-bloque6" data-slide-to="<?php
print $count ?>" class="<?php ($count == 0) ? print 'active' : '' ;
?>"></li>
          <?php $count++; ?>
          <?php endforeach ?>
        </ol>
        <div class="hidden-xs hidden-sm">
          <div class="tabs tabs-style-linebox">
            <nav>
              <ul>
                <?php $count = 0; ?>
                <?php foreach ($titulos_tab_bloque_6 as $key =>
$titulo_tab_bloque_6): ?>
                <li class="<?php ($count == 0) ? print 'tab-current' : '' ; ?>">
                  <a href="bloque-seis-<?php print $count;
?>"><span><?php print $titulo_tab_bloque_6['value'] ?></span>
                  </a>
                </li>
                <?php $count++; ?>
                <?php endforeach ?>
            ...
            <div class="content-wrap bg-gray-lighter" style="color: black;">
              <?php $count = 0; ?>
              <?php foreach ($cuerpos_tab_bloque_6 as $key =>
$cuerpo_tab_bloque_6): ?>
              <section id="bloque-seis-<?php print $count; ?>"
class="<?php ($count == 0) ? print 'content-current' : '' ; ?>">
                <p style="color: black;"><?php print
$cuerpo_tab_bloque_6['value'] ?></p>
              </section>
              <?php $count++;?>
              <?php endforeach ?>
            </div><!-- /content -->
      ...
      <div class="hidden-lg">
        ...
        <div class="panel-group" id="accordion2" role="tablist" aria-multiselectable="true">
          ...
          <div class="panel panel-default" style="min-height: 30px;">
            ...
            <div id="collapse2<?php print $count; ?>"
class="panel-collapse collapse" role="tabpanel"
aria-labelledby="heading2<?php print $count; ?>">
              <div class="panel-body">
        ...
        <div class="carousel-inner mt-42" role="listbox">
          ...
          <div class="item <?php ($count == 0) ? print 'active' : '' ; ?>">
            <div class="banner banner-label-bottom mb-7 ml-0">
              <div class="banner-pic" style="background-image:
url(<?php print image_style_url($image_style,
$imagen_bloque_6['uri']); ?>);">
              </div>
            </div>
          </div>
