			...
			<div class="nav-display-right">
				<div>
					<ul>
						...
						<li>
							<?php if ($language->language != 'en'): ?>
								<a href="/educacion-ejecutiva/profesores" class="atm-menu-secundario">
									Profesores
								</a>
							<?php elseif ($language->language == 'en'): ?>
								<a href="/<?php print $language->language ?>/executive-education/faculty" class="atm-menu-secundario">
									Faculty
								</a>
							<?php endif ?>
							</a>
