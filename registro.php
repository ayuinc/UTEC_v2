...
if($idioma == "es")
{
           ...
           $origen == "Traslado Externo" || $origen == "Centro Pre" || $origen == "Bachillerato Internacional")
        {
            ...
            if ($origen == "Bachillerato Internacional")
            {
                ...
                $tituloTelemarketing = "EXAMEN ADMISION - Datos Personales";
                $subjectTelemarketing = "Solicitud - Informes Admisión UTEC";
                $familia = "EXAMEN-ADMISION";
                $origen = "pagina-examen-de-admision";  
            }     
...
$headers .= 'From: Informes UTEC <informes@utec.edu.pe>' . "\r\n";

$to = "ecaycho@utec.edu.pe, ecaycho@tecsup.edu.pe";
*/
...
#mail($to,$subjectTelemarketing,$mensaje_html,$headers);
