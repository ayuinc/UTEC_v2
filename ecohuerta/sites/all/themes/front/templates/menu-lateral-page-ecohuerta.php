<ul class="nav nav-point">
  ...
  <!-- <li class="<?php if(strcmp(request_uri(),'ecohuerta/ecohuerta-video-lechugas-hidroponicas')==0){print active;}?>">
    <div class="nav-point-text-arrow">
  ...
  <li class="<?php if(strcmp(request_uri(),'ecohuerta/ecohuerta-recetas')==0){print active;}?>">
    <div class="nav-point-text-arrow">
