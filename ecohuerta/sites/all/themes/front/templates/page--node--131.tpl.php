 ...
 <div id="page-wrapper">
  ...
  <div class="content" id="fullpage">
    <?php
      ...
      $nid=$video[0]->nid;
      $node = node_load($nid);
      $vd = $node->field_media['und'][0]['input'];
      $image = $node->field_image['und'][0]['filename'];
  ?>
<section id="que-haremos" class="main" style="background-image: url('<?php print $pathfile.'/'.$image; ?>');">
  <div id="que-haremos-r" class="responsive-fix"></div>
 
  <div class="container" style="padding-top: 250px">
    <div class="modal modal-center">
      <a href="<?php print($vd); ?>" class="icon1 icon-play fancybox-media"></a>
