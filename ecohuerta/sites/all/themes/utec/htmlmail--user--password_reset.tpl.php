...
global $base_url;
$link_reset = array();
preg_match_all("/http:\/\/".$_SERVER['SERVER_NAME']."\/[^\s]*/", $body, $link_reset);
?>
    ...
    <tr>
      <td width="800" colspan="3" >
        <table border="0" align="left" cellpadding="0" cellspacing="0">
          <tr>
            <td width="800" style="font-family: arial;font-size: 20px;font-weight: normal;padding-top: 80px;padding-bottom: 0px; padding-left:33px;color:#00bbe4;">
              Estimado(a) <?php echo $params['account']->name; ?>:
            </td>
          </tr>
          <tr>
            <td width="800" colspan="2" align="left" style="color:#444444;font-family: arial;font-size: 18px;font-weight: normal;padding-top: 0;padding-left:33px;padding-bottom: 30px;line-height:1.5;">
              Para poder recuperar su clave haz clic en el siguiente botón.
            </td>
          </tr>
          <tr>
            <td width="800" colspan="2" align="left" style="font-family: arial;font-size: 18px;padding: 0 33px 58px;">
              <a href="<?php echo $link_reset[0][0];?>" style="text-decoration:none;background:#00bbe4; color:white; padding:10px 10px;">Recuperar contraseña</a>
            </td>
          </tr>
        </table>
      </td>
